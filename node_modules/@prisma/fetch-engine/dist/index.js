...
__export(index_exports, {
  ...
  download: () => import_chunk_4UQSCQXR.download,
  engineEnvVarMap: () => import_chunk_PXQVM7NP.engineEnvVarMap,
  getBinaryEnvVarPath: () => import_chunk_PXQVM7NP.getBinaryEnvVarPath,
  getBinaryName: () => import_chunk_4UQSCQXR.getBinaryName,
  getCacheDir: () => import_chunk_YJOPKU47.getCacheDir,
  getProxyAgent: () => import_chunk_LOOX3H4O.getProxyAgent,
  getVersion: () => import_chunk_4UQSCQXR.getVersion,
  maybeCopyToTmp: () => import_chunk_4UQSCQXR.maybeCopyToTmp,
  overwriteFile: () => import_chunk_YJOPKU47.overwriteFile,
  plusX: () => import_chunk_4UQSCQXR.plusX,
  vercelPkgPathRegex: () => import_chunk_4UQSCQXR.vercelPkgPathRegex
});
module.exports = __toCommonJS(index_exports);
var import_chunk_4UQSCQXR = require("./chunk-4UQSCQXR.js");
